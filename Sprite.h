...
protected:
	...
	SDL_Texture* bg = g->getBackground();
public:
	...
	void jump(SDL_Texture* bg, SDL_Texture* sprite, SDL_Rect &bgsrc, SDL_Rect &bgdest, bool &right)
	{
		bool complete = false;
		while (!complete)
		{
			SDL_RenderCopy(g->getRenderer(), bg, NULL, NULL);
			SDL_RenderCopy(g->getRenderer(), sprite, &bgsrc, &bgdest);
	...
	void runleft(SDL_Texture* bg, SDL_Rect &bgsrc, SDL_Rect &bgdest, bool &right)
	{
